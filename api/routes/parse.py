...
def _detect_format(filename: str, content: str) -> str:
    ...
    Returns 'fw_log', 'htmodem', 'htrouter', 'atak', 'relay_manager', 'rsdk', or 'diagnostic'.
    ...
    Detection order:
      ...
      4. ATAK          — filename starts with 'diagnostic_ATAK_' (legacy), or
      ...
      5. Relay Manager — filename or content signals the goTenna Relay Manager app
      6. RSDK          — filename contains 'rsdk' or content has RSDK line markers
      7. Diagnostic    — fallback (goTenna Pro+ block format)
    """
    name = filename.lower()
