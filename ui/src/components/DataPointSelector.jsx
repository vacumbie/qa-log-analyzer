...
export const DATA_POINTS = [
  // ── Thermal ──────────────────────────────────────────────────────────────
  { id: 'temp_over_time',    group: 'Thermal',  label: 'PA Temp Over Time (°F)',       formats: ['diagnostic','rsdk'] },
  { id: 'temp_peak',         group: 'Thermal',  label: 'Peak PA Temp per Device',      formats: ['diagnostic','rsdk'] },

  // ── Battery ───────────────────────────────────────────────────────────────
  { id: 'battery_over_time', group: 'Battery',  label: 'Battery % Over Time',          formats: ['diagnostic','rsdk'] },
  { id: 'battery_min',       group: 'Battery',  label: 'Min Battery per Device',       formats: ['diagnostic','rsdk'] },

  // ── Hop Count ─────────────────────────────────────────────────────────────
  { id: 'hop_distribution',  group: 'Hop Count', label: 'Hop Count Distribution',      formats: ['diagnostic'] },
  { id: 'hop_avg',           group: 'Hop Count', label: 'Avg Hop Count per Device',    formats: ['diagnostic'] },

  // ── RSSI ──────────────────────────────────────────────────────────────────
  { id: 'rssi_by_hop',       group: 'RSSI',     label: 'RSSI by Hop Count',            formats: ['diagnostic'] },
  { id: 'rssi_avg_device',   group: 'RSSI',     label: 'Avg RSSI per Device',          formats: ['diagnostic'] },

  // ── PLI ───────────────────────────────────────────────────────────────────
  { id: 'pli_intervals',     group: 'PLI',      label: 'PLI Intervals per Originator', formats: ['diagnostic'] },
  { id: 'pli_vs_chat',       group: 'PLI',      label: 'PLI vs Chat Message Split',    formats: ['diagnostic'] },
  ...
  // ── Sessions ──────────────────────────────────────────────────────────────
  { id: 'session_lengths',   group: 'Sessions', label: 'Session Lengths',              formats: ['diagnostic','rsdk'] },
]
