...
| 6 | Next-Gen Radio — Modem | Next-gen radio (SDR/FPGA) | `ht-modem` process log, ctime-style stdout capture | `parser/htmodem.py` ⏳ *(spec only, not yet implemented)* |
| 7 | Next-Gen Radio — Router | Next-gen radio (SDR/FPGA) | `ht-router` process log, ISO8601 stdout capture | `parser/htrouter.py` ⏳ *(spec only, not yet implemented)* |
